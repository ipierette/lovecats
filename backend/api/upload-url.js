...
import { UploadUrlSchema }  from '../lib/schemas.js';
...
/**
 * POST /api/upload-url
 * Gera uma URL assinada para que o frontend envie o arquivo DIRETO ao Supabase
 * Storage, sem passar pelo Vercel (evita o limite de 4,5 MB na função).
 *
